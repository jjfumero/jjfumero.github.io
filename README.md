Note: this website is a fork of the [academicpages/academicpages.github.io](https://github.com/academicpages/academicpages.github.io) project.
...
```bash
cd _layouts/
rsync -avhW --delete --progress /home/juan/repos/academicpages.github.io/_layouts/* .
cd ../_includes
rsync -avhW --delete --progress /home/juan/repos/academicpages.github.io/_includes/* .
cd ../_sass
rsync -avhW --delete --progress /home/juan/repos/academicpages.github.io/_sass/* .
cd ../assets
rsync -avhW --delete --progress /home/juan/repos/academicpages.github.io/assets/* .
```
