...
Note that the examples shown are based on the tests for the Intel compute runtime and Level Zero available on [GitHub](https://github.com/intel/compute-runtime/blob/master/level_zero/core/test/black_box_tests/zello_timestamp.cpp).
